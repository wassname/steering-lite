...
# Below this the two signs scored the same and the tie-break is arbitrary. A rate-style
# probe over n items resolves 1/n, so this is "at least two items apart" at the usual n=10.
